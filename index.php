    ...
    <div class="container">
     ...
     <hr class="mx-auto">
      ...
      <div class="mx-auto container">
        ...
        <div class="form-group" >
       <label>Email</label> 
       <input type="text" class="form-control" id="registeremail" name="email" placeholder="Email"required>
       </div>
       ...
       <div class="form-group" >
        ...
        <div class="form-group" >
            <input type="submit" class="btn" id="register-btn" value="Register" name="sub">
            </div>
          
         <div class="form-group" >
            <a id="login-url" class="btn" href="login1.php" > Do you have an account? Login</a>
          </div>
       </form>
      </div>
      </section>
